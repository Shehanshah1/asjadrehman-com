    ...
    <section className="max-w-3xl mx-auto px-4 py-10 leading-relaxed">
      ...
      <div className="fade-section-delay-3 space-y-4">
        <div className="grid gap-3 sm:grid-cols-2">
          <a
            href="mailto:asjad@asjadrehman.com"
            className="hover-card flex items-center gap-3 rounded-lg p-4 group"
          >
            <div className="flex items-center justify-center w-10 h-10 rounded-full bg-gray-100 dark:bg-zinc-800 text-gray-600 dark:text-zinc-400 group-hover:text-blue-500 transition-colors">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="16" x="2" y="4" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg>
            </div>
            <div>
              <span className="text-sm font-medium text-gray-900 dark:text-zinc-100 group-hover:text-blue-500 dark:group-hover:text-blue-400 transition-colors">Email</span>
              <p className="text-xs text-gray-500 dark:text-zinc-500">asjad@asjadrehman.com</p>
            </div>
          </a>
          <a
          ...
          >
            ...
            <div>
              <span className="text-sm font-medium text-gray-900 dark:text-zinc-100 group-hover:text-blue-500 dark:group-hover:text-blue-400 transition-colors">LinkedIn</span>
          ...
          >
            ...
            <div>
              <span className="text-sm font-medium text-gray-900 dark:text-zinc-100 group-hover:text-blue-500 dark:group-hover:text-blue-400 transition-colors">X (Twitter)</span>
          ...
          >
            ...
            <div>
              <span className="text-sm font-medium text-gray-900 dark:text-zinc-100 group-hover:text-blue-500 dark:group-hover:text-blue-400 transition-colors">GitHub</span>
